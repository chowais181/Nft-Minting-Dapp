    ...
    >
      <div className="flex flex-col justify-center items-center mx-auto py-10">
        <div className="flex flex-col justify-center items-center">
          ...
          <a
            href="https://chowais181.github.io/Resume-M.Awais-Zahid/"
          ...
          >
            ...
            <div className="flex flex-col font-semibold">
              ...
              <span className="text-[#e32970] text-xs">Awais</span>
            </div>
          </a>

          <p className="text-white text-sm font-medium text-center">
            Awais Zahid kick-started his journey as a software engineer in 2016.{" "}
            <br /> Over the years, he has grown full-blown skills in JavaScript
            stacks such as <br /> React, Node and now blockchain.
          </p>
          ...
          <ul className="flex flex-row justify-center space-x-2 items-center my-4">
            <a
              ...
              href="https://github.com/chowais181"
            >
