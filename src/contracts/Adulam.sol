...
// for writing nft smart contracts
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
import "@openzeppelin/contracts/access/Ownable.sol";


// inherting the smart contracts 
contract Adulam is ERC721Enumerable, Ownable {
    // convertuing unsigned int into string
    using Strings for uint256;

    string baseURI;
    // gathering the information about each nft maintained on this network
